<?php
/**
 * Template Name: Plantilla directivos
 *
 * @Face
 * @
 */
						...
						$comments->the_post(); ?>
							<div class="col-sm-12 col-md-6 structure-box">
								<div class="row">
									...
									<div class="col-xs-9">
										<div class="row text">
											<h5>DIRECTOR DE DEPARTAMENTO:</h5>
						...
						$comments->the_post(); ?>
							<div class="col-sm-12 col-md-6 structure-box">
								<div class="row">
									...
									<div class="col-xs-9">
										<div class="row text">
											<h5>DIRECTOR ESCUELA DE CONTADOR PÚBLICO AUDITOR:</h5>
											<strong><?php the_title(); ?></strong>
											<?php the_content(); ?>
										</div>
									</div>
						...
						$comments->the_post(); ?>
							<div class="col-sm-12 col-md-6 structure-box">
								<div class="row">
									...
									<div class="col-xs-9">
										<div class="row text">
											<h5>DIRECTOR ESCUELA DE INGENIERÍA COMERCIAL:</h5>
											<strong><?php the_title(); ?></strong>
											<?php the_content(); ?>
										</div>
									</div>
