...
/**
 * Registrar todas las acciones y filtros (LAS ACCIONES ANTES QUE LOS FILTROS !IMPORTANTE)
 *
 ...
 * y registrarlos con la API de WordPress. 
...
class GE_Pre_Cargador {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array    $actions    Las acciones registradas en WordPress para ejecutar.
	 */
    protected $actions;
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array    $actions    Las filtros registrados en WordPress para ejecutar.
	 */
	protected $filters;
	 ...
	 * @param    string    $hook             El nombre del filtro de WordPress que se está registrando.
	 * @param    object    $component        Una referencia a la instancia del objeto en el que se define la acción o filtro.
	 * @param    string    $callback         El nombre de la definición del método/función en el $component.
